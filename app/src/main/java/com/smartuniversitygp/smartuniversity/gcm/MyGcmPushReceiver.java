...
/**
 * Created by Muhammad Shaaban on 23/06/2016.
 */
...
import com.smartuniversitygp.smartuniversity.activity.BollaActivity;
...
public class MyGcmPushReceiver extends GcmListenerService {
    ...
    public void onMessageReceived(String from, Bundle bundle) {
        ...
        if (!NotificationUtils.isAppIsInBackground(getApplicationContext())) {
            ...
            Intent resultIntent = new Intent(getApplicationContext(), BollaActivity.class);
